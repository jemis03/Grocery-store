...
<head>
	<title>Welcome to Groci Store</title>
		...
		<div class="home-welcome-text" style="background-image: url(image/background.jpg); height: 380px; ">
			<div style="padding-top: 120px;">
				<div style=" background-color: #dadbe6;">
					<h1 style="margin: 0px;">Welcome To Groci Store</h1>
					<h2>Most Convenient Store in Ahmedabad</h2>
				</div>
			</div>
		</div>
	</div>
	<div class="home-prodlist" style="background-color: #c5c5c5">
		<div>
			<h1 style="text-align: center; padding-top:4rem">Products Category</h1>
		</div>
		<div class="imgss" style="display: flex;
			flex-wrap:wrap;
  justify-content: center;
  align-items: center;padding: 20px 30px; width: 85%; margin: 0 auto;">
			<ul style="">
